...
public class OsUtil {
    ...
    private static boolean sIsAtAndroidO;
    private static boolean sIsAtAndroidO_MR1;
    ...
    static {
        ...
        sIsAtAndroidO = v == Build.VERSION_CODES.O;
        sIsAtAndroidO_MR1 = v == Build.VERSION_CODES.O_MR1;
     ...
     *  (API level 26).
     */
    public static boolean isAtAndroidO() {
        return sIsAtAndroidO;
    }

    /**
     * @return True if the version of Android that we're running on is at least O MR1
     *  (API level 27).
     */
    public static boolean isAtAndroidO_MR1() {
        return sIsAtAndroidO_MR1;
    }

    /**
     * @return True if the version of Android that we're running on is at least P
     *  (API level 28).
     */
    ...
    /**
     * @return True if the version of Android that we're running on is at least Q
     *  (API level 29).
     */
    ...
    public static boolean hasPermission(Context context,final String permission) {
        if (OsUtil.isAtLeastM()) {
            Log.d("OsUtil","============hasPermission==1===permission: "+permission);
            ...
            boolean hasPermission =  sPermissions.get(permission) == PackageManager.PERMISSION_GRANTED;
            Log.d("OsUtil","===========hasPermission===2=====: "+hasPermission);
            return hasPermission;
        } else {
            Log.d("OsUtil","============hasPermission===3==permission: "+permission);
            return true;
        }
    }
    ...
    private static String[] cellBroadcastRequiredPermissions = new String[] {
    ...
    public static boolean hasRequiredPermissions(Context context) {
        return hasPermissions(context,cellBroadcastRequiredPermissions);
    }

    public static String[] getMissingRequiredPermissions(Context context) {
        return getMissingPermissions(context,cellBroadcastRequiredPermissions);
    }

    public static void requestMissingPermission(Activity act){
        act.requestPermissions(getMissingRequiredPermissions(act),0);
    }
}
